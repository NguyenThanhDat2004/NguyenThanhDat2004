...
🚀 **Current Focus:** Mastering **SwiftUI** & **Flutter** to build seamless cross-platform experiences.

🧠 **Philosophy:** *"Code with purpose, design with passion."*

🏗️ **Architecture:** Strong believer in **Clean Architecture**, MVVM, and writing testable code.

## 🛠 Tech Stack
**📱 Mobile**
<p>
<img src="https://skillicons.dev/icons?i=swift,flutter,dart,kotlin,android" />
</p>

**🌐 Frontend & Tools**
<p>
<img src="https://skillicons.dev/icons?i=react,js,html,css,git,vscode,apple,firebase" />
</p>

## 🚀 Featured Projects
| Project | Tech Stack | Status |
|---------|------------|--------|
| 🗒️ **Note Taking App** | `SwiftUI` `CoreData` `Clean Architecture` | ✅ Live |
| 🌤️ **Weather App Mini** | `SwiftUI` `REST API` `Async/Await` | ✅ Live |
| 🧾 **Expense Manager** | `SwiftUI` `UserDefaults` `Charts` | ✅ Live |
| ✅ **Todo List** | `Flutter` `MVVM` `Provider` | ✅ Live |
